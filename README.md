Small code snippets in different programming languages showing how to use our [REST-API](https://github.com/hickerspace/REST-API) ([docs](http://hickerspace.org/wiki/REST-API)).
